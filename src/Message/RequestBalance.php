...
class RequestBalance extends AbstractRequest
{
    protected $liveEndpoint = 'https://qvapay.com/api/v1/balance';
    protected $testEndpoint = 'https://stage.qvapay.com/api/v1/balance';
    ...
    {
        return $this->response = new ResponseBalance($this, $data);
    }
